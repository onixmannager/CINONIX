...
import { getFirestore, doc, getDoc, collection, query, where, getDocs, updateDoc, setDoc, arrayUnion, increment } from "https://www.gstatic.com/firebasejs/11.3.0/firebase-firestore.js";
...
/** ✅ FUNCION PARA GUARDAR Y PERSISTIR EL CÓDIGO DE REFERIDO */
function manejarReferido() {
  const urlParams = new URLSearchParams(window.location.search);
  const referido = urlParams.get("afiliado");
